...
<<<<<<< HEAD
        public static PostEntity QueryPostById(string databaseName, string collectionName, string postId)
        {
            DocumentClient client = new DocumentClient(new Uri(EndpointUri), PrimaryKey);

            PostEntity entity = client.CreateDocumentQuery<PostEntity>(
             UriFactory.CreateDocumentCollectionUri(databaseName, collectionName))
             .Where(x => x.Id == postId)
             .AsEnumerable()
             .First();
...
=======
            ...
            string postId)
        {
            ...
            return entity;
>>>>>>> adc2d93315f009332d1bd188d9d9ea008c8689d8
        }
    }
}