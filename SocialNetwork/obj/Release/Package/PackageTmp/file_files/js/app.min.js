...
if ("undefined" == typeof jQuery)throw new Error("Kulbox's JavaScript requires jQuery");
+function (a) {
    "use strict";
    function b() {
    ...
    c.VERSION = "3.2.0", c.DEFAULTS = {
        ...
        number:2,
        cycle:true,
        wrap: !0}, c.prototype.keydown = function (a) {
        switch (a.which) {
            case 37:
                this.prev();
                break;
...
$('.scroll-thumb .carousel').carousel({
    interval: false,
})

$('.scroll-thumb .carousel .item').each(function(){
    var next = $(this).next();
    if (!next.length) {
...
$(document).ready(function () {
    ...
    setTimeout(function(){
        var numsThumb;
        var heightThumb = $('.scroll-thumb img').height();
        var widthThumb = $('.scroll-thumb img').width();

        if (heightThumb < widthThumb) {
            $('.scroll-thumb').addClass('typepic2');
            $('.thumb-item').removeClass('col-md-6');
            $('.thumb-item').addClass('col-md-6')

        } else {
            $('.scroll-thumb').addClass('typepic1');
            $('.thumb-item').removeClass('col-md-4');
            $('.thumb-item').addClass('col-md-4');
            $('#video').height(213)
