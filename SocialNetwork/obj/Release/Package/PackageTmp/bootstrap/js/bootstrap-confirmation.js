	...
	* ======================= */
	...
	$.fn.confirmation.defaults = $.extend({} , $.fn.tooltip.defaults, {
		...
		, template: '<div class="popover">' +
				...
				'<div class="btn-group">' +
				'<a class="btn btn-sm" href="" target="" data-onConfirm="onConfirm"></a>' +
		...
		, btnOkLabel: '<i class="glyphicon glyphicon-ok-circle"></i> Yes'
		, btnCancelLabel: '<i class="glyphicon glyphicon-remove-circle"></i> No'
		, singleton: false
		, popout: true
		, onConfirm: function () {}
		, onCancel: function(){}
